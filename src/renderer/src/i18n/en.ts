export const en = {
  ...
  tagsTab: {
    ...
    searchPlaceholder: 'Search tags from library…',
    ...
    massAssignHint: 'Search tags above, check rows in the table, enter folder name, then Apply.',
    ...
    customHint:
      'Fully custom disk paths outside your default LoRA/Checkpoint roots. Comma-separated tag aliases (e.g. tool, tools).',
